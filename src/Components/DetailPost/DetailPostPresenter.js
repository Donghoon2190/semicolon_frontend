...
import { HeartFull, HeartEmpty, Comment as CommentIcon, Circle } from "../Icons";
...
export default ({
  ...
  //스테이트로 수정을 눌렀을때는 인풋창 기본일때는 그냥 캡션.
  // 메뉴에 온클릭에서 스테이트를 변환해줘야함.
  return (
    <Div>
      <Post>
      ...
      <PostComment>
        <Meta>
          <Header>
            ...
            <MoreButton >
              {<EditPopup setEditButton={setEditButton} />}
            </MoreButton>
          </Header>
